...
@CommandParameters(description = "Manage your admin entry.", usage = "/<command> [-o <admin name>] <clearips | clearip <ip> | setacformat <format> | setscformat <format> | clearscformat> | syncroles>")
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        switch (args[0])
        {
            ...
            case "setacformat":
            {
                ...
                String example = format.replace("%name%", "ExampleAdmin").replace("%rank%", Rank.SUPER.getAbbr()).replace("%rankcolor%", Rank.SUPER.getColor().toString()).replace("%msg%", "The quick brown fox jumps over the lazy dog.");
