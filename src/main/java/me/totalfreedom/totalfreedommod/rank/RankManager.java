...
public class RankManager extends FreedomService
{
    ...
    public Displayable getDisplay(CommandSender sender)
    {
        ...
        if (ConfigEntry.SERVER_COOWNERS.getList().contains(player.getName()) && plugin.al.isAdmin(player))
        {
            return Title.COOWNER;
        }

        if (ConfigEntry.SERVER_SYSTEM_ADMINS.getList().contains(player.getName()) && plugin.al.isAdmin(player))
        {
